...
/// 视图模型
@property (nonatomic, readonly, strong) SSTableVM *viewModel;
@end
...
/// init
- (instancetype)initWithViewModel:(SSTableVM *)viewModel {
...
- (UIEdgeInsets)contentInset{
    return UIEdgeInsetsMake(NavAndStatusHight, 0, 0, 0);
}
