...
- (void)_setupNavigationBarBottomLine{
    ...
    UIImageView *navSystemLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.navigationBar.frame.size.height - navSystemLineH, SCREENWIDTH, navSystemLineH)];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated{
    ...
    if (self.viewControllers.count > 0){
        ...
        if ([viewController isKindOfClass:[SSBaseViewController class]]) {
            
            SSViewModel *viewModel = [(SSBaseViewController *)viewController viewModel];
