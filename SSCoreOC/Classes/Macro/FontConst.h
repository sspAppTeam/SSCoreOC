...
////适配字体
#define SizeScale           (iPhoneX ? 1.2 : 1)
#define SmallFont     [UIFont systemFontOfSize:12*SizeScale]//统一的小号字体
#define MiddleFont    [UIFont systemFontOfSize:13*SizeScale]//统一的中号字体
#define bigFont       [UIFont systemFontOfSize:15*SizeScale]//统一的大号字体
