...
{
    return [[NSDateFormatter dateFormatter] dateFromString:timestamp];
}
...
{
    return [[NSDateFormatter dateFormatter] stringFromDate:[NSDate date]];
}
...
- (NSString *)mh_formattedDateDescription
{
    ...
    if ([self mh_isThisYear])
    {
        ...
        if ([self mh_isToday]) {
            ...
            // 星期二 22:22
            dateFormatter = [NSDateFormatter dateFormatterWithFormat:[NSString stringWithFormat:@"%@ HH:mm" , [self mh_weekDay]]];
        }else{
            // 2016年08月18日 22:22
        ...
        // 非今年
        dateFormatter = [NSDateFormatter dateFormatterWithFormat:@"yyyy年MM月dd日"];
    }
